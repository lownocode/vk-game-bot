...
export const wheel = async (user, game, rate, results) => {
    ...
    if (rate.data.number === 0 && game.data.number === 0) {
    ...
    if (
        (rate.data.bet === "even" && game.data.number !== 0 && game.data.number % 2 === 0) ||
        (rate.data.bet === "noteven" && game.data.number !== 0 && game.data.number % 2 !== 0) ||
